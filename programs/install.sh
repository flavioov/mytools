...
sudo apt-get install -y lynx gparted vim gdebi nautilus git byobu gimp synaptic pdfshuffler okular tree speedcrunch vlc csh tcsh openssh-client openssh-server wakeonlan autossh
...
"
sudo apt-get install -y  openssh network-manager-openvpn*
